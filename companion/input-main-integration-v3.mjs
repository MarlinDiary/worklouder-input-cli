...
// A versioned import URL lets an already-running Input process replace the
// adapter module atomically without restarting or focusing the GUI.
import { createInputMainAdapter } from "./input-main-adapter.mjs?live-overlay-v3";
